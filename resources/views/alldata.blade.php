...
<div class="container mt-4">
   ...
   <div class="table-responsive">
    <table class="table table-bordered table-sm custom-table" id="alldatatable">
...
if (record.latest_remark) {
    remark = `<a href="/remark?sales_record_id=${record.id}">${record.latest_remark}</a>`;
}
            ...
            if (data.length === 0) {
                ...
                data.forEach(function (record) {
                    ...
                    if (record.last_remark) {
                        remark = `<a href="/remark?sales_record_id=${record.id}">${record.last_remark}</a>`;
                    }
                    html += `
                        <tr>
                            <td>${record.status_name ?? 'N/A'}</td>
...
$(document).on('change', '#from_date, #to_date', function () {
    ...
    loadDateFilteredTable(from_date, to_date, 1); // Start from page 1
});
