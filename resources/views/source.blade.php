...
<div class="container mt-4">
      ...
      <button class="btn button" data-bs-toggle="modal" data-bs-target="#createSourceModal">
            <i class="bi bi-plus-lg"></i> Create Source
        </button>
        
<div class="table-responsive">
<table class="table table-hover table-bordered align-middle text-center border shadow-sm rounded" id="salesSourceTable">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="edit_source_name" required>
          </div>
        </div>
        <div class="modal-footer">
...
function loadSource(page = 1) {
    $.get(`{{ route('source.fetch') }}?page=${page}`, function (data) {
        let rows = '';
        $.each(data.data, function (i, s) {
            rows += `<tr>
                <td>${s.source_name}</td>
                <td>
                    <button class="btn btn-sm btn-primary editBtn" data-id="${s.id}" data-name="${s.source_name}">
